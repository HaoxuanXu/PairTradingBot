...
func (model *PairTradingModel) UpdateProfitThreshold() {
	model.MinProfitThreshold.Low = model.CalculateMinProfitThreshold(30.0)
	model.MinProfitThreshold.High = model.CalculateMinProfitThreshold(40.0)
